...
/**
 * Definiert eine Substitutionschiffre mittels XOR.
 *
 * @author Klaus Köhler, koehler@hm.edu
 * @author Reinhard Schiedermeier, rs@cs.hm.edu
 * @version 24.05.2008
 */
public class XorSubstitution extends Substitution {
    @Override
